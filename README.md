...
# Leaker Flow – Open Source Platform to Build, Manage and Train AI Agents

![Leaker Flow Screenshot](frontend/public/banner.png)

**The complete platform for creating autonomous AI agents that work for you**

Leaker Flow is a comprehensive open source platform that empowers you to build, manage, and train sophisticated AI agents for any use case. Create powerful agents that act autonomously on your behalf, from general-purpose assistants to specialized automation tools.
...
## 🌟 What Makes Leaker Flow Special

### 🤖 Includes Leaker Flow – Flagship Generalist AI Worker
Meet Leaker Flow, our showcase agent that demonstrates the full power of the Leaker Flow platform. Through natural conversation, Leaker Flow handles research, data analysis, browser automation, file management, and complex workflows – showing you what's possible when you build with Leaker Flow.

### 🔧 Build Custom Leaker Flow–Type Agents
Create your own specialized agents tailored to specific domains, workflows, or business needs. Whether you need agents for customer service, data processing, content creation, or industry-specific tasks, Leaker Flow provides the infrastructure and tools to build, deploy, and scale them.
...
- [🌟 What Makes Leaker Flow Special](#-what-makes-leaker-flow-special)
...
Leaker Flow demonstrates the full capabilities of the Leaker Flow platform as a versatile AI worker that can:
...
The Leaker Flow platform enables you to create agents tailored to specific needs:
...
Leaker Flow consists of four main components that work together to provide a complete AI agent development platform:
...
Get your Leaker Flow platform running in minutes with our automated setup wizard:
...
That's it! Your Leaker Flow platform will be running with Leaker Flow ready to assist you.

## 🏠 Self-Hosting

Leaker Flow can be self-hosted on your own infrastructure using our comprehensive setup wizard, giving you complete control over your AI agent platform. For a complete guide to self-hosting Leaker Flow, please refer to our [Self-Hosting Guide](./docs/SELF-HOSTING.md).
...
The wizard will guide you through all necessary steps to get your Leaker Flow platform up and running. For detailed instructions, troubleshooting tips, and advanced configuration options, see the [Self-Hosting Guide](./docs/SELF-HOSTING.md).

## 🤝 Contributing

We welcome contributions from the community! Whether you're fixing bugs, adding features, or improving documentation, your help makes Leaker Flow better for everyone.
