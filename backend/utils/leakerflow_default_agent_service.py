...
class LeakerflowDefaultAgentService:
    ...
    async def sync_all_default_agents(self) -> Dict[str, Any]:
    ...
    async def update_all_default_agents(self, target_version: Optional[str] = None) -> Dict[str, Any]:
        logger.info("🔄 Delegating to modular sync service (version auto-detected)")
        return await self.sync_all_default_agents()
    ...
    async def get_default_agent_stats(self) -> Dict[str, Any]:
