...
class SandboxWebSearchTool(SandboxToolsBase):
    ...
    @usage_example('''
        ...
        <parameter name="query">what is LeakerFlow AI and what are they building?</parameter>
    ...
    @usage_example('''
        ...
        <parameter name="urls">https://www.leakerflow.com/,https://github.com/leakerflow/leakerflow</parameter>
        </invoke>
        </function_calls>
        ''')
