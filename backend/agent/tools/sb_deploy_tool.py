...
class SandboxDeployTool(SandboxToolsBase):
    ...
    @openapi_schema({
        ...
        "function": {
            "name": "deploy",
            "description": "Deploy a static website (HTML+CSS+JS) from a directory in the sandbox to Cloudflare Pages. Only use this tool when permanent deployment to a production environment is needed. The directory path must be relative to /workspace. The website will be deployed to {name}.leakerflow.cloud.",
            "parameters": {
                "type": "object",
                "properties": {
                    "name": {
                        "type": "string",
                        "description": "Name for the deployment, will be used in the URL as {name}.leakerflow.cloud"
                    },
                    "directory_path": {
                        "type": "string",
    ...
    async def deploy(self, name: str, directory_path: str) -> ToolResult:
        ...
        Args:
            name: Name for the deployment, will be used in the URL as {name}.leakerflow.cloud
