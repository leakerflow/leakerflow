...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'hello@leakerflow.com')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Leaker Flow — Let's Get Started "
...
<head>
  ...
  <title>Welcome to Leaker Flow</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://leakerflow.com/favicon.png" alt="Leaker Flow Logo" class="logo">
    </div>
    <h1>Welcome to Leaker Flow!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Leaker Flow — we're excited to have you on board!</strong></em></p>
    ...
    <p><strong>For your business:</strong> if you want to automate manual and ordinary tasks for your company, book a call with us <a href="https://cal.com/team/leakerflow/enterprise-demo">here</a></p>

    <p>Thanks again, and welcome to the Leaker Flow community <span class="emoji">🌞</span></p>

    <p>— The Leaker Flow Team</p>

    <a href="https://leakerflow.com/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Leaker Flow — we're excited to have you on board!
...
For your business: if you want to automate manual and ordinary tasks for your company, book a call with us here: https://cal.com/team/leakerflow/enterprise-demo 

Thanks again, and welcome to the Leaker Flow community 🌞

— The Leaker Flow Team

Go to the platform: https://leakerflow.com/

---
© 2024 Leaker Flow. All rights reserved.
You received this email because you signed up for a Leaker Flow account."""
