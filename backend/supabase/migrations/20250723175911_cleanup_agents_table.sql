...
COMMENT ON COLUMN agents.metadata IS 'Agent metadata including is_leakerflow_default, centrally_managed flags, and restrictions - crucial for default agent functionality';
