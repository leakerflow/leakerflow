...
2. Build a custom image:
   ...
   docker push leakerflow/leakerflow:0.1.3
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `leakerflow/leakerflow:___`)
...
3. Push the new version: `docker push leakerflow/leakerflow:0.1.3`
