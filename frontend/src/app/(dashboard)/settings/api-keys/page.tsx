      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Manage your API keys for programmatic access to Leaker Flow
          </p>
        </div>
          ...
          <CardContent className="">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <a 
                    href="https://github.com/leakerflow/leakerflow/tree/main/sdk" 
                    target="_blank" 
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Create your first API key pair to start using the Leaker Flow
                API programmatically. Each key includes a public identifier and
