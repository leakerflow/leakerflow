...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Leaker Flow',
    description: 'Replay this Agent conversation on Leaker Flow',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Leaker Flow';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Leaker Flow';
