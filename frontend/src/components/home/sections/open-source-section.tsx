      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          ...
          <p className="text-muted-foreground text-center text-balance font-medium">
            Leaker Flow is fully open source. Join our community and help shape the
            future of AI.
          </p>
        </SectionHeader>
        ...
        <span>leakerflow/leakerflow</span>
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mt-2">
                  Explore, contribute, or fork our repository. Leaker Flow is built
                  with transparency and collaboration at its core.
                </p>
              </div>
              <div className="flex flex-wrap gap-2">
                <span className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold bg-brand-gradient border-transparent text-white">
                  TypeScript
                </span>
                <span className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold bg-brand-gradient border-transparent text-white">
                  Python
        ...
        href="https://github.com/leakerflow/leakerflow"
                ...
                className="group inline-flex h-10 items-center justify-center gap-2 text-sm font-medium tracking-wide rounded-full text-black px-6 shadow-[inset_0_1px_2px_rgba(255,255,255,0.25),0_3px_3px_-1.5px_rgba(16,24,40,0.06),0_1px_1px_rgba(16,24,40,0.08)] bg-white hover:bg-white/90 transition-all duration-200 w-fit"
              >
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-start gap-3">
                  <div className="rounded-full p-2 mt-0.5 bg-brand-gradient text-white">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 24 24"
