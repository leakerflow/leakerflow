...
const CardAvatar: React.FC<{ isLeakerFlowAgent?: boolean; profileImageUrl?: string; agentName?: string }> = ({ isLeakerFlowAgent = false, profileImageUrl, agentName }) => { if (isLeakerFlowAgent) {
    return (
    ...
    <div className={cardClassName} onClick={() => onClick?.(data)}>
      ...
      <div className="relative p-6 flex flex-col flex-1">
        <div className="flex items-start justify-between mb-4">
          <CardAvatar isLeakerFlowAgent={isLeakerFlowAgent} profileImageUrl={(data as any)?.profile_image_url} agentName={data.name} />
