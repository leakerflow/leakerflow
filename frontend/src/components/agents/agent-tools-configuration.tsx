...
export const AgentToolsConfiguration = ({ tools, onToolsChange, disabled = false, isLeakerFlowAgent = false, isLoading = false }: AgentToolsConfigurationProps) => {
  ...
  const handleToolToggle = (toolName: string, enabled: boolean) => {
    if (disabled && isLeakerFlowAgent) {
      toast.error("Tools cannot be modified", {
        description: "LeakerFlow's default tools are managed centrally and cannot be changed.",
      });
      return;
    }
