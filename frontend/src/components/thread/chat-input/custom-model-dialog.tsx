        ...
        >
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Leaker Flow usa <b>LiteLLM</b> por baixo dos panos, o que o torna compatível com mais de 100 modelos. Você pode escolher qualquer <a href="https://openrouter.ai/models" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 underline">modelo do OpenRouter</a> prefixando com <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">openrouter/</code> e deve funcionar imediatamente. Para usar outros provedores além do OpenRouter, talvez seja necessário ajustar o arquivo <a href="https://github.com/kortix-ai/suna/blob/main/backend/services/llm.py" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 underline">llm.py</a>, configurar as variáveis de ambiente corretas e reconstruir seu container Docker self-hosted.
                    </DialogDescription>
