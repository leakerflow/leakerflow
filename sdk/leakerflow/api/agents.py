...
class AgentsClient:
    """SDK client for Leaker Flow Agents API with httpx client supporting custom headers"""
    ...
    def __init__(
        ...
        Args:
            base_url: Base URL of the API (e.g., "https://api.leakerflow.com/api")
...
client = create_agents_client(
    base_url="https://leakerflow.com/api",
    auth_token="your-jwt-token"
)

# Usage with custom headers
client = create_agents_client(
    base_url="https://api.leakerflow.com/api",
    auth_token="your-jwt-token",
    custom_headers={
